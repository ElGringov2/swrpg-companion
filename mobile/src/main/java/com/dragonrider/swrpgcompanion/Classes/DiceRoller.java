...
public class DiceRoller {
	...
	protected void RefreshMainView() {
		...
		innerRollResult.PopulateFullView((ViewGroup) baseView.findViewById(R.id.PopupDiceRollerListDice));
		
		innerRollResult.PopulateResult((ViewGroup) baseView.findViewById(R.id.PopupDiceRollerListResults));
